const VolatilityLab = {
    render() {
        ...
        <div class="grid-2 gap-5" style="margin-bottom:var(--space-5);">
            ...
            <div style="font-family:var(--font-mono);font-size:48px;font-weight:700;color:var(--accent-warn);">${this.marketVolatilityIndex().toFixed(2)}</div>
        ...
        <div style="margin-top:var(--space-4);">${this.renderDistributionChart()}</div></div>`;
    },
        ...
        return `<div style="display:flex;align-items:flex-end;gap:var(--space-4);height:200px;padding:var(--space-4) 0;">
            ${Object.entries(buckets).map(([label, count]) => {
                ...
                return `<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:var(--space-2);">
                    ...
                    <div style="width:100%;background:${color};border-radius:var(--radius-sm);transition:height 0.5s var(--ease-snappy);" style="height:${pct}%;"></div>
